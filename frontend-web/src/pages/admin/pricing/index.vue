...
const pricing = ref<PricingConfig>({download:{unitPrice:200,description:'按题计费'},print:[{tier:1,minQuantity:1,maxQuantity:10,unitPrice:500},{tier:2,minQuantity:11,maxQuantity:50,unitPrice:400},{tier:3,minQuantity:51,maxQuantity:null,unitPrice:300}]})
