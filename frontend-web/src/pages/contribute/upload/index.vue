...
import { uploadContributionFile } from '@/api/modules/contribution'
...
async function submit() {
  ...
  try {
    await uploadContributionFile(formData, {
...
<template>
  <div class="upload-page">
    <div class="breadcrumb">
      ...
      <span class="breadcrumb__separator">›</span>
      <span class="breadcrumb__current">上传题目</span>
    </div>
    <div class="page-card">
      <h3>上传题目文件</h3>
      <div class="mt-md">
      ...
      <el-button type="primary" size="large" :loading="uploading" class="submit-button mt-md" @click="submit">
        上传并提交
      </el-button>
    </div>
  </div>
